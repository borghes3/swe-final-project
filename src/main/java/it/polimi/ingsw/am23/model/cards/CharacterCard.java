...
public abstract class CharacterCard extends Card{
    ...
    protected CharacterCard(String id, Era era, int points, CharacterType characterType){
        super(id, era, points);
    ...
    protected void onAddedToTribe(Game game, Player player){} //di default vuoto
}
